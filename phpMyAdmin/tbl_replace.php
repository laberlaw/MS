...
foreach ($loop_array as $rownumber => $where_clause) {
    ...
    // @todo possibly movie to ./libraries/tbl_replace_fields.inc.php
...
if ($is_insert && count($value_sets) > 0) {
    ...
    // No change -> movie back to the calling script
    //
...
/**
 * Executes the sql query and get the result, then movie back to the calling
 * page
 */
