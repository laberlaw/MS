...
class PMA_File
{
    ...
    */
    ...
    /**
     * If we are on a server with open_basedir, we must movie the file
     * before opening it. The FAQ 1.11 explains how to create the "./tmp"
     * directory - if needed
     *
     * @todo movie check of $cfg['TempDir'] into PMA_Config?
     * @access  public
     ...
     *
     * @todo    movie file read part into readChunk() or getChunk()
