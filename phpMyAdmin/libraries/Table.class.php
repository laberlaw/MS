...
class PMA_Table
{
     ...
     * @param string      $index
     *
     * @todo    movie into class PMA_Column
     ...
     * @param bool   $move         whether to movie
    ...
    static public function moveCopy($source_db, $source_table, $target_db, $target_table, $what, $move, $mode)
    {
        ...
        // Drops old table if the user has requested to movie it
        if ($move) {
    ...
    function rename($new_name, $new_db = null, $is_view = false)
    {
        ...
        /**
         * @todo movie into extra function PMA_Relation::renameTable($new_name, $old_name, $new_db, $old_db)
         */
